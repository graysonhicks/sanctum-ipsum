  ...
  render() {
    return (
        <div className="sidebar-container">
            ...
            <form action="">
                <ParagraphSelectComponent updateParagraphs={this.props.updateParagraphs}></ParagraphSelectComponent>
                <SentenceSelectComponent updateSentences={this.props.updateSentences}></SentenceSelectComponent>
